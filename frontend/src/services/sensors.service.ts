...
import type { Sensor, SensorReading, CreateSensorDTO, UpdateSensorDTO, SensorQueryParams, RecordSensorReadingDTO } from '@/types/sensor';
import type { ApiResponse, PaginatedResponse } from '@/types/api';

export const getSensors = async (params?: SensorQueryParams): Promise<PaginatedResponse<Sensor>> => {
...
export const createSensor = async (payload: CreateSensorDTO): Promise<Sensor> => {
...
export const updateSensor = async (id: string, payload: UpdateSensorDTO): Promise<Sensor> => {
