...
import type { MaintenanceRecord, CreateMaintenanceDTO, UpdateMaintenanceDTO, MaintenanceQueryParams } from '@/types/maintenance';
import type { ApiResponse, PaginatedResponse } from '@/types/api';

export const getMaintenanceList = async (params?: MaintenanceQueryParams): Promise<PaginatedResponse<MaintenanceRecord>> => {
...
export const getMaintenance = async (id: string): Promise<MaintenanceRecord> => {
...
export const createMaintenance = async (payload: CreateMaintenanceDTO): Promise<MaintenanceRecord> => {
...
export const updateMaintenance = async (id: string, payload: UpdateMaintenanceDTO): Promise<MaintenanceRecord> => {
