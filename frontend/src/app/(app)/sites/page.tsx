...
export default function SitesPage() {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message ||
          err.message ||
          "An error occurred saving the site.",
      );
    } finally {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      console.error(err);
      toast.error(
        err.response?.data?.message || err.message || "Failed to delete site.",
      );
    } finally {
      setIsSubmitting(false);
    }
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Select
              value={status || "all"}
              onValueChange={(val) =>
                setStatus(val === "all" ? undefined : (val as SiteStatus))
              }
            >
        ...
        <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              <DialogTitle>
                {selectedSite ? "Edit Mining Site" : "Add New Mining Site"}
              </DialogTitle>
              <DialogDescription>
                {selectedSite
            ...
            >
              <div className="space-y-1">
                ...
                <Input
                  id="name"
                  {...form.register("name")}
                  placeholder="E.g., North Shaft Pit"
                />
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="E.g., Nevada Sector-4"
                />
          ...
          <DialogContent className="sm:max-w-sm">
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                ? This action is irreversible and all linked resources might be
                affected.
              </DialogDescription>
            </DialogHeader>
