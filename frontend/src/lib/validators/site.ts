...
export const siteSchema = z.object({
  ...
  areaSqKm: z.coerce.number().positive('Area must be positive').optional().or(z.literal('')),
  workerCount: z.coerce.number().int().min(0, 'Worker count cannot be negative').optional(),
